...
use CjsHttp\Contracts\SessionInterface;
use CjsHttp\Bag\ParameterBag;
...
class Request
{
     ...
     *
     * @var \CjsHttp\Bag\ServerBag
     */
    public $server;

    /**
     * Uploaded files ($_FILES).
     * @var \CjsHttp\Bag\FileBag
     */
    public $files;
    ...
    /**
     * @var \CjsHttp\Contracts\SessionInterface
     */
    protected $session;
